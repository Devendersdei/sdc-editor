	...
	$("#btn_Images").on("click", function () {
		...
		$.ajax({
			...
			success: function (response) {
				debugger
				$(".fr-image-container").remove();
				$(".load_all").html(response);
				$(".load_all").show();
			}
		});
	});
