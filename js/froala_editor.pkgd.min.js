	...
	$.ajax({
		...
		success: function (response) {
			...
			for (index = 0; index < response.length; index++) {
				if (column == 0) {
					$('#fr-image-list .fr-list-column:nth-child(1) .fr-image-container').append('<img src= "' + response[index].url + '" data-url="' + response[index].thumb + '" data-tag="' + response[index].tag + '" alt="' + response[index].name + '" data-id="' + response[index].id + '" data-name="' + response[index].name + '" data-type="' + response[index].type + '">');
					column++;
				} else if (column == 1) {
					$('#fr-image-list .fr-list-column:nth-child(2) .fr-image-container').append('<img src= "' + response[index].url + '" data-url="' + response[index].thumb + '" data-tag="' + response[index].tag + '" alt="' + response[index].name + '" data-id="' + response[index].id + '" data-name="' + response[index].name + '" data-type="' + response[index].type + '">');
					column++;
				} else if (column == 2) {
					$('#fr-image-list .fr-list-column:nth-child(3) .fr-image-container').append('<img src= "' + response[index].url + '" data-url="' + response[index].thumb + '" data-tag="' + response[index].tag + '" alt="' + response[index].name + '" data-id="' + response[index].id + '" data-name="' + response[index].name + '" data-type="' + response[index].type + '">');
					column++;
				} else if (column == 3) {
					$('#fr-image-list .fr-list-column:nth-child(4) .fr-image-container').append('<img src= "' + response[index].url + '" data-url="' + response[index].thumb + '" data-tag="' + response[index].tag + '" alt="' + response[index].name + '" data-id="' + response[index].id + '" data-name="' + response[index].name + '" data-type="' + response[index].type + '">');
					column = 0;
				}
			}
			$(".fr-image-container").show();
