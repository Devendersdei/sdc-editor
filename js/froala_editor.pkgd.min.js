	...
	$.ajax({
		...
		success: function (response) {
			...
			for (index = 0; index < response.length; index++) {
				var imageManagerPageSizeCount = response.length;
				$('#fr-image-list .fr-list-column:nth-child(' + column + ') .fr-image-container').append('<img src= "' + response[index].url + '" data-url="' + response[index].thumb + '" data-tag="' + response[index].tag + '" alt="' + response[index].name + '" data-id="' + response[index].id + '" data-name="' + response[index].name + '" data-type="' + response[index].type + '">');
				if (column == 4) {
					column = 1;
				} else {
					column++;
