...
! function(a) {
    ...
    b.DEFAULTS = {
        initOnClick: !1,
        pluginsEnabled: null
    }, b.MODULES = {}, b.PLUGINS = {}, b.VERSION = "2.6.4", b.INSTANCES = [], b.OPTS_MAPPING = {}, b.SHARED = {}, b.ID = 0, b.prototype._init = function() {
    ...
    if (a.FE.LinkRegExCommon = "(([" + c + "])|([" + c + "](\\.|-|_))){1,}[" + c + "]{1,}", a.FE.LinkRegExEnd = "((:[0-9]{1,5})|())((\\/[a-z\\u00a1-\\uffff0-9@?^=%&amp;/~+#-_{}]*)|())", a.FE.LinkRegExTLD = "((" + a.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", a.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/(www\\.)?" + a.FE.LinkRegExCommon + ")", a.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/(www\\.)?[\\u0021-\\uffff]{1,}@" + a.FE.LinkRegExCommon + ")", a.FE.LinkRegExWWW = "(((ftp|http|https):\\/\\/)?www\\." + a.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", a.FE.LinkRegEx = "(" + a.FE.LinkRegExTLD + "|" + a.FE.LinkRegExHTTP + "|" + a.FE.LinkRegExAuth + "|" + a.FE.LinkRegExWWW + ")" + a.FE.LinkRegExEnd, a.FE.MAIL_REGEX = /.+@.+\..+/i, a.FE.MODULES.helpers = function(b) {
            ...
            function d(a) {
                return -1 != ["PRE", "SCRIPT"].indexOf(a.tagName)
            }
            ...
            function L(c) {
                ...
                do {
                    ...
                    for (var h = 0; h < f.length; h++) {
                        ...
                        if (d != i) {
                            var j = i.textContent;
                            0 === i.children.length && 1 === j.length && 8203 == j.charCodeAt(0) && (a(i).remove(), g = !0)
                        }
                    }
                } while (g)
            }
            ...
            function w(c) {
                var d = c.which;
                if (t(c) || d >= 37 && d <= 40 || !v(d) && d != a.FE.KEYCODE.DELETE && d != a.FE.KEYCODE.BACKSPACE && d != a.FE.KEYCODE.ENTER && 229 != d) return !0;
            ...
            function x(a) {
                ...
                E && D ? (b.undo.saveStep(E), E = null) : void 0 !== c || E || D || b.undo.saveStep()
            }
            ...
            function i() {
                ...
                }!0 === a.ul && h(), a.events.on("contentChanged", function() {
                    !0 === a.ul && g() && h()
            ...
            function g() {
                b.selection.save(), b.events.disableBlur(), q = null, s ? s.html("") : (s = a('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 9999; line-height: 140%;" tabIndex="-1"></div>'), b.browser.safari ? (s.css("top", b.$sc.scrollTop()), b.$el.after(s)) : b.$box.after(s), b.events.on("destroy", function() {
                    s.remove()
            ...
            function j() {
                ...
                c && "string" == typeof c && (q = c), (!a || a && !1 !== b.events.trigger("paste.wordPaste", [q])) && k(q, a)
            }
            ...
            function k(c, d, e) {
                ...
                if (c.indexOf('id="docs-internal-guid') >= 0 && (c = c.replace(/^.* id="docs-internal-guid[^>]*>(.*)<\/b>.*$/, "$1"), k = !0), !d) {
                    ...
                    o.innerHTML = c;
                    var p = b.win.localStorage.getItem("fr-copied-html"),
            ...
            function d(c, d) {
                ...
                return e += '<div class="fr-modal-head">' + c + '<i title="' + b.language.translate("Cancel") + '" class="fa fa-times fr-modal-close"></i></div>', e += '<div tabIndex="-1" class="fr-modal-body" > <div class="fr-input-line"><input type="text" style ="height: 30px; width: 90%; margin:10px;" onkeydown="winReadData(event)" id="gss-search" placeholder="Search here..."/></div>  '  + d + "</div>", e += "</div></div>", a(e)
            }
            ...
            function q(c) {
                ...
                }, !0), b.helpers.isIOS() && b.events.$on(c, "touchend", '.fr-file-upload-layer input[type="file"]', function() {
            ...
            function j(c) {
                ...
                if (Ja)
                    for (d = 0; d < Ja.length; d++) f.indexOf(Ja[d].getAttribute("src")) < 0 && b.events.trigger("image.removed", [a(Ja[d])]);
                if (Ja && c) {
                    var g = [];
                    for (d = 0; d < Ja.length; d++) g.push(Ja[d].getAttribute("src"));
            ...
            function y(a, c, d, e, f) {
                ...
                g.onload = function() {
                    ...
                    } else c = E(a, d, x), j(!1), b.undo.saveStep(), b.events.trigger("image.inserted", [c, f])
                }, g.onerror = function() {
                    p(Ca)
            ...
            function H(a, c) {
                if (void 0 !== a && a.length > 0) {
                    if (!1 === b.events.trigger("image.beforeUpload", [a])) return !1;
                    var d = a[0];
            ...
            function I(c) {
                ...
                }), b.helpers.isIOS() && b.events.$on(c, "touchend", '.fr-image-upload-layer input[type="file"]', function() {
                    a(this).trigger("click")
            ...
            var xa, ya, za, Aa, Ba = !1,
                ...
                Ha = 6,
                Ia = {};
            Ia[Ca] = "Image cannot be loaded from the passed link.", Ia[Da] = "No link in upload response.", Ia[Ea] = "Error during file upload.", Ia[Fa] = "Parsing response failed.", Ia[Ga] = "File is too large.", Ia[Ha] = "Image file type is invalid.", Ia[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.";
            var Ja, Ka, La = !1;
            return {
                _init: aa,
                showInsertPopup: d,
            ...
            function c() {
                if (!z) {
                    var a = '<div class="fr-modal-head-line"><h4 data-text="true">' + b.language.translate("Manage Images") + "</h4></div>";
    ...
    a.FE.DEFAULTS.imageInsertButtons.push("imageManager"), a.FE.RegisterCommand("imageManager", {
        ...
        function r(f, g, h) {
            ...
            var l, m = c();
            if (m) l = a(m), l.attr("href", f), g.length > 0 && l.text() != g && !i && l.text(g),
                i || l.prepend(a.FE.START_MARKER).append(a.FE.END_MARKER), l.attr(h), i || b.selection.restore();
            else {
        ...
        function Q(c) {
            ...
            }), b.helpers.isIOS() && b.events.$on(c, "touchend", '.fr-video-upload-layer input[type="file"]', function() {
                a(this).trigger("click")
        ...
        function j(a) {
            return a.nodeType == Node.ELEMENT_NODE && a.getAttribute("style") && -1 != a.getAttribute("style").replace(/\n/gi, "").indexOf("mso-list:Ignore")
        }
        ...
        function m(a, b) {
            var c = a.cloneNode(!0);
            if (c.firstElementChild && "A" == c.firstElementChild.tagName && (c = c.firstElementChild), h(c.firstElementChild), -1 != ["H1", "H2", "H3", "H4", "H5", "H6"].indexOf(a.tagName)) {
            ...
            i(c, function(a) {
                return a.nodeType == Node.ELEMENT_NODE && w(a, b), !0
            });
            var e = c.innerHTML;
        ...
        function n(a, b) {
            ...
            var e = d ? "ol" : "ul",
                ...
                j = a.parentNode;
            for (h(a), a = null; i && k(i);) {
                var o = i.previousElementSibling,
                    p = l(i);
                if (p > f) g += n(i, b).outerHTML;
                else {
                    if (p < f) break;
                    g += "</li><li>" + m(i, b)
                }
                ...
                } else i = o ? o.nextElementSibling : j.firstElementChild
            }
            g += "</li></" + e + ">";
        ...
        function v(a, b) {
            if (b) {
                ...
                if (c && -1 != c.indexOf("file://")) {
                    var d = a.getAttribute("v:shapes");
                    if (d) {
                        if (/^[a-zA-Z]+_/gi.test(d) && a.previousSibling) {
                        ...
                        if (!h || 2 == h.length) {
                            ...
                            if (!(i && i.length < 2)) {
                                var j = null;
                                if (-1 != i[0].indexOf("pngblip") ? j = "image/png" : -1 != i[0].indexOf("jpegblip") && (j = "image/jpeg"), j) {
                                    var k = i[1].split("}");
                                    if (!(k && k.length < 2)) {
                                        var l;
                                        if (k.length > 2 && -1 != k[0].indexOf("blipuid")) l = k[1].split(" ");
                                        else {
                                            if ((l = k[0].split(" ")) && l.length < 2) return;
                                            l.shift()
                                        }
                                        var m = l.join(""),
                                            n = u(m),
        ...
        function w(b, c) {
            var d = b.tagName,
                e = d.toLowerCase();
            if (b.firstElementChild && ("I" == b.firstElementChild.tagName ? o(b.firstElementChild, "em") : "B" == b.firstElementChild.tagName && o(b.firstElementChild, "strong")), -1 != ["SCRIPT", "APPLET", "EMBED", "NOFRAMES", "NOSCRIPT"].indexOf(d)) return h(b), !1;
            ...
            if ("TD" != d) {
                ...
                if (c && i) {
                    ...
                    for (f = 0; f < j.length; f++) {
                        ...
                        for (var n = 0; n < l.length; n++) c[l[n]] && s(b, c[l[n]])
                    }
                }
                c && c[e] && s(b, c[e])
            }
            if (-1 != ["P", "H1", "H2", "H3", "H4", "H5", "H6", "PRE"].indexOf(d)) {
                ...
                if (t && (c && c[d.toLowerCase() + "." + t] && s(b, c[d.toLowerCase() + "." + t]), -1 != t.toLowerCase().indexOf("mso"))) {
                    var u = r(t);
            ...
            if ("TR" == d && p(b, c), "A" == d && !b.attributes.getNamedItem("href") && b.innerHTML && (b.outerHTML = b.innerHTML), "TD" != d && "TH" != d || b.innerHTML || (b.innerHTML = "<br>"), "TABLE" == d && (b.style.width = "100%"), b.getAttribute("lang") && b.removeAttribute("lang"), b.getAttribute("style") && -1 != b.getAttribute("style").toLowerCase().indexOf("mso")) {
                var x = r(b.getAttribute("style"));
        ...
        function y(c, d) {
            ...
            i(j, function(b) {
                if (b.nodeType == Node.TEXT_NODE && /\n/.test(b.data)) {
                    if (!/\S/.test(b.data)) return b.data == a.FE.UNICODE_NBSP || (h(b), !1);
                    b.data = b.data.replace(/\n/gi, " ")
                }
                return !0
            }), i(j, function(a) {
                return a.nodeType == Node.ELEMENT_NODE && "IMG" == a.tagName && v(a, d), !0
            }), i(j, function(a) {
            ...
            return b.opts.htmlAllowedStyleProps = b.opts.wordAllowedStyleProps, m = b.clean.html(m, b.opts.wordDeniedTags, b.opts.wordDeniedAttrs, !1), b.opts.htmlAllowedStyleProps = o, m
        }
...
(function(){
  ...
  var ctrlKey;
  var count = 0;
  	window.winReadData = function(event) {
      // debugger;
      $('#gss-search').bind("copy", function(){
        var copyText = $('#gss-search')
        copyText.select();
        document.execCommand("copy");

        console.log('copy', copyText  );
      });
      $('#gss-search').bind("cut", function(){
        var copyText = $('#gss-search')
        copyText.select();
        document.execCommand('cut');
        console.log('cut');
      });
      $('#gss-search').bind("paste", function(){
      ...
      // $("#gss-search").addClass('fr-active');
        	$('#gss-search').val(searchTerm)

    	// filter images.
    	// console.log($('.fr-image-container'))
      $(".fr-image-container").hide()

    	// $(".fr-image-container").each(function() {
      //   var searchTag = 'img[data-tag*= "'+searchTerm+'"]'
      //   $( ".fr-image-container").find(searchTag).parent().fadeIn();

      // });
      searchText = searchTerm.toLowerCase();
      $(".fr-image-container >  img").filter(function() {
        return $(this).attr('data-tag').toLowerCase().indexOf(searchText) > -1;
      }).parent().fadeIn();


	  	if(searchTerm == ''){
    		$( ".fr-image-container" ).show()
    	}
    ...
    // var key = e.charCode || e.keyCode || 0;
		// if(  key == 35 || key == 91 || key == 92 || key == 93 || key == 37 || key == 38 || key == 39 || key == 40 || key == 16 ) {
	  //   	return false;
    //   }
    //   // if (key > 32 && (key < 48 && key > 58 ) && key !== 127) {
		// if (key > 32 || (key < 48 || key > 58 ) || key !== 127 ||  keycode == 32 || keycode == 13 ) {

	  //     return true;
    // }
    // return false;

    // if (e.keyCode == 17 && e.keys.ctrlKey(e)) {

      // if(e.keyCode == 17 && count == 0) {
      //     count = 1;
      // }
      // if (count == 1 && e.keyCode == 67 ) {
      //     // e.trigger( "window.copy" );
      //     // document.execCommand('copy');
      //     count = 0;
      //     return false;

      // }
      // if (count == 1 && e.keyCode == 88 ) {
      //   document.execCommand('cut');
      //   count = 0;
      //   return false;

      // }
      // if (count == 1 && e.keyCode == 86 ) {
      //   document.execCommand('paste');
      //   count = 0;
      //   return false;

      // }
      // if(count == 1 && e.keyCode == 65 ) {
  ...
  $('.fr-modal').css('z-index', '99999999999');
