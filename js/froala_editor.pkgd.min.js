	...
	$("#btn_Images").on("click", function () {
		...
		$.ajax({
			...
			success: function (response) {
				debugger
				$(".fr-image-container").html(response).show();
			}
		});
	});
}