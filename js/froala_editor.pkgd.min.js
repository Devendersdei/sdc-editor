	...
	$.ajax({
		...
		success: function (response) {
			...
			for (index = 0; index < response.length; index++) {
				$('.fr-image-'+index+'"').empty();
				$('#fr-image-list .fr-list-column:nth-child(' + column + ') .fr-image-container . fr-image-'+index+'"').append(
					'<img src= "' + response[index].url + '" data-url="' + response[index].thumb + '" data-tag="' + response[index].tag + '" alt="' + response[index].name + '" data-id="' + response[index].id + '" data-name="' + response[index].name + '" data-type="' + response[index].type + '"><i class="fa fa-trash fr-delete-img" aria-hidden="true" title="Delete"></i><i class="fa fa-plus fr-insert-img" aria-hidden="true" title="Insert"></i>');
