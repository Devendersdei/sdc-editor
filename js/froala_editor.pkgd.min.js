...
window.winReadImages = function (event) {
	$("#btn_Images").on("click", function () {
		...
		$.ajax({
			...
			success: function (response) {
				debugger
				$("#fr-image-list").show(response);
				// $(".fr-image-container").html(response.base);
			}
		});
	});
}
