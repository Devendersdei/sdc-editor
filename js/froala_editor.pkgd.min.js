	...
	$("#btn_Images").on("click", function () {
		...
		$.ajax({
			...
			success: function (response) {
				debugger
				// response.forEach((index , image) => {
				// $(".fr-image-container").append('<img src= "'+ image.url +'" data-url="'+ image.thumb +'" data-tag="'+image.tag+'" alt="'+image.name+'" data-id="'+image.id+'" data-name="'+image.name+'" data-type="'+image.type+'">');
				// $(".fr-image-container").show();
				// });
				for (index = 0; index < response.length; index++) { 
					$(".fr-image-container").remove();
					$(".fr-image-container").append('<img src= "'+ response[index].url +'" data-url="'+ response[index].thumb +'" data-tag="'+response[index].tag+'" alt="'+response[index].name+'" data-id="'+response[index].id+'" data-name="'+response[index].name+'" data-type="'+response[index].type+'">');
					$(".fr-image-container").show();
				} 
			}
		});
