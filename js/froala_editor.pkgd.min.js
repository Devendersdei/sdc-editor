	...
	$.ajax({
		...
		success: function (response) {
			...
			for (index = 0; index < response.length; index++) {
				...
				$('#fr-modal-tags').append('<a role="button" title="' + response[index].tag + '" style="opacity: 1;">' + response[index].tag + '</a>')
				if (column == 4) {
					column = 1;
				} else {
					column++;
...
$('#fr-modal-tags a').click(function () {
	$(this).addClass('fr-selected-tag');
});
