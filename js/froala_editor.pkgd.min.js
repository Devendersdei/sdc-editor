	...
	$("#btn_Images").on("click", function () {
		...
		$.ajax({
			...
			success: function (response) {
				...
				$(".fr-image-container").append('<img src= "'+ response.url +'" data-url="'+ response.thumb +'" data-tag="'+response.tag+'" alt="'+response.name+'" data-id="'+response.id+'" data-name="'+response.name+'" data-type="'+response.type+'">');
				$(".fr-image-container").show();
				});
			}
		});
